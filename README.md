...
### Software used
- python3.7, jupyter notebook, pandas, matplotlib libraries
### Data source
- I explored publicly available food grain production dataset from https://data.gov.in/resources/stateut-and-crop-wise-production-foodgrains-2016-17-2019-20-ministry-agriculture-and.
